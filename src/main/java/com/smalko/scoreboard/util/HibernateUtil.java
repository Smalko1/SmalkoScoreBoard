...
public class HibernateUtil {
    ...
    /*@SneakyThrows
    private static SessionFactory createMatchesPlayers() {
        try (var sessionFactory = HibernateUtil.getSession()) {
            ...
            PlayerService playerService = new ByteBuddy()
                    ...
                    var transactionInterceptor = new TransactionInterceptor(sessionFactory(), session);
             */
...
/*
            ...
            var match1 = matchesService.createMatch(matchesCreateDto1, session);
            ...
            var match2 = matchesService.createMatch(matchesCreateDto2, session);
